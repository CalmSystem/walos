...
// Extracted from musl libc - MIT Rich Felker, et al.
// Probably destroyed in the process.
// Please dont report bugs to the original project.
...
#endif
static const float tointf = 1/FEPS;

#if FLT_EVAL_METHOD==0 || FLT_EVAL_METHOD==1
#define DEPS DBL_EPSILON
#elif FLT_EVAL_METHOD==2
#define DEPS LDBL_EPSILON
#endif
static const double tointd = 1/DEPS;
