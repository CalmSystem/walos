...
#   define d_m3EnableCodePageRefCounting        0       // can it free code
# endif
...
#   define d_m3EnableOpTracing                  0       // only works with M3_DEBUG
# endif

# ifndef d_m3EnableStrace
#   define d_m3EnableStrace                     0       // 1 - trace exported function calls
                                                        // 2 - trace all calls (structured) - requires M3_DEBUG
